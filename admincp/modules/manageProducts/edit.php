    ...
    <form action="modules/manageProducts/handle.php?idsanpham=<?php echo $_GET['id']; ?>" enctype="multipart/form-data" method='POST'>
        <table class="products-table">
            ...
            <tbody id="table-body"> 
                ...
                <tr>
                    <td style='width:200px'>Phân loại</td>
