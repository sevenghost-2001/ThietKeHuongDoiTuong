        ...
        if ($query) { 
            ...
            while ($row_email = mysqli_fetch_array($query_email)) {
                ...
                try {
                    ...
                    $mail->Body    = "<h2 style='color:pink'>Xin chào các bạn! Tại cửa hàng chúng tôi đang có khuyến mãi lớn, hãy vào mua sắm ngay thôi nào ".$tenkhuyenmai."</h2><a href='http://localhost/CNPM-PHP/index.php?danhmuc=khuyenmai'>http://localhost/CNPM-PHP/index.php?danhmuc=khuyenmai'</a>";
