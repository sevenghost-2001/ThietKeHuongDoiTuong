        ...
        <div class="container demo-1">
            <div class="content">
                <div id="large-header" class="large-header">
                    <h1>Website bán quần áo trực tuyến của Nhóm 4Men</h1>
                    <div class="main-agileits">
                        ...
                        <div class="form-w3-agile dangky">
                            ...
                            <form action="./Logined/Dangky" method="post">
                                ...
                                <p class="p-bottom-w3ls1">Bạn đã có tài khoản?<a class href="http://localhost:8080/banquanaohuongdoituong/Logined/Dangnhap"> Đăng nhập</a></p>
                                <div class="clear"></div>
