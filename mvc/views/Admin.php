...
if(!isset($_SESSION['id'])||$_SESSION["role"]==1){
    header("Location:http://localhost:8080/banquanaohuongdoituong/Logined/Dangxuat");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <li class="navbar-item">
                                <a href="http://localhost:8080/banquanaohuongdoituong/Logined/Dangxuat" class="nav-link">Đăng xuất</a>
                            </li>
                        </ul>
                    </div>
                </nav>
