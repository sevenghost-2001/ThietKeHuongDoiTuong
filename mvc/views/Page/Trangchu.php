                        ...
                        <div class="item">
                            <div class="slide">
                                ...
                                <div class="content">
                                    <div class="title">
                                        <h3>Chào mừng bạn đến với Website bán quần áo của Nhóm 4Men</h3>
                                        <h5>Vẻ đẹp thanh tao toát lên từ cách ăn mặc</h5>
                                        <a href="DanhMucSanPham.html" class="btn">Tìm Sản Phẩm</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="slide">
                                ...
                                <div class="content">
                                    <div class="title">
                                        <h3>Chào mừng bạn đến với Website bán quần áo của Nhóm 4Men</h3>
                                        <h5>Phong cách của người dẫn đầu</h5>
                                        <a href="DanhMucSanPham.html" class="btn">Tìm Sản Phẩm</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <div class="gioiThieuBookStore">
                        ...
                        <div class="btn-sec">
                            <a href="DanhMucSanPham.html" class="btn yellow">Tìm Sản Phẩm</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="share align-middle">
                            <span class="fb"><a href="https://www.facebook.com/nguyentuanhung12345" target="_blank"> <i class="fa fa-facebook-official"></i> </a></span>
