                       ...
                       <table id="cart" class="table table-hover table-condensed">
                        ...
                        <tr>
                              ...
                              <th class="hidden-xs text-center" >
                                ...
                                <th>
                                <a href="http://localhost/project/Admin/Bieudodoanhthu" class="btn btn-success btn-block">Biểu đồ</a>
                                </th>
                                <th>
                        ...
                        <tbody>
                            ...
                            <?php
                              ...
                              $doanhthu=0;
                                ...
                                echo '</td>
                                <td>
                                <a href="http://localhost/project/Admin/Chitietgiohang/'.$row[$i]->iddathang.'" class="btn btn-success btn-block">Chi tiết giỏ hàng</a>
                                  </tr>';
                                }
                                echo '</td>
                                Doanh thu:
