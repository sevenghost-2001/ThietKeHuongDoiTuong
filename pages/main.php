<div class="container">
    <div class="container__wrapper">
        <?php
            ...
            if ($temp == 'quan' || $temp == 'ao' || $temp == 'tuixach' || $temp == 'sanpham') {
                include("main/product.php");
            }  
            else if ($temp == 'khuyenmai') {
                include("main/promotion.php");
                echo "<script>document.getElementsByTagName('title')[0].innerHTML = 'Khuyến mãi khủng';</script>";
            }
            else if (isset($_GET['chitietsanpham'])) {
                ...
                echo "<script>document.getElementsByTagName('title')[0].innerHTML = 'Giỏ hàng';</script>";
            }
