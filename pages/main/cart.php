        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input onclick="updateAmount(<?php echo $_SESSION['cart'][$i]['id']; ?>)" id="<?php echo $_SESSION['cart'][$i]['id']; ?>" type="number" id="" min="1" class="input amount" value="<?php echo $_SESSION['cart'][$i]['amount']; ?>"> 
                    </td>
                    <td>
