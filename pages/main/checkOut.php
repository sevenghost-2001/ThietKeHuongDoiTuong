        ...
        <form action="pages/main/pay.php?total=<?php echo $total; ?>" method="POST" id="check-out-info-form">
            ...
            <div class="check-out-info check-out-method">
                ...
                <div class="info-method-1" id="info-method-1" >
                    <span>Lưu ý: Khách hàng vui lòng liên hệ với cửa hàng để xác nhận thông tin trước khi chuyển khoản</span>
                    <p>
                        <b>NGÂN HÀNG QUÂN ĐỘI - MB BANK - Chi nhánh Nguyễn Tri Phương</b><br>
                        Số tài khoản: 0987654321<br>
                        Chủ tài khoản: Admin SHOP
                    </p>
                    <br>
                    <p>
