<?php
    ...
    if ($temp == 'quan') {
        $id_category = 1;
        echo "<script>document.getElementsByTagName('title')[0].innerHTML = 'Quần tây 5THEWAY';</script>";
    }
    else if ($temp == 'ao') { 
        $id_category = 2;
        echo "<script>document.getElementsByTagName('title')[0].innerHTML = 'Áo thun HIDANZ';</script>";
    }
    else if ($temp == 'tuixach') { 
        $id_category = 3;
        echo "<script>document.getElementsByTagName('title')[0].innerHTML = 'Túi Xách Thời Trang Gucci';</script>";
    } 
    else {
